...
The difference is `mongo` is a shell, and `mongosh` is a shell for MongoDB with more features and better syntax.🤦‍♀️ <br> 3. Install Redis and Redis Cluster <br> 4. Nginx for Load balancing to multiple node containers<br> 5. Dev to Prod <br> 6. Automating
